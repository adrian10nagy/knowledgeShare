...
namespace Softvision.Helpers
{
    public class SessionHelper : Controller
    {
        ...
        public UserTypeBL UserType()
        {
            ...
            {
                return UserTypeBL.Prospect;
            }

            return (UserTypeBL)int.Parse(System.Web.HttpContext.Current.Session["userType"].ToString());
        }
        ...
        public void setUser(UserBL user)
        {
